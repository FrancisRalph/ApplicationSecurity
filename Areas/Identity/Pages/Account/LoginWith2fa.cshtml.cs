...
namespace ApplicationSecurity.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        public LoginWith2faModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginWith2faModel> logger, AuditLogService auditLogService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            else
            {
                ...
                await _auditLogService.AddAuditLogAsync(Request, user, LogAction.Wrong2Fa);
                return Page();
            }
        }
    }
